...
@torch.no_grad()
class AutoEncoder_37(nn.Module):
    def __init__(self, dim_mask=128, mask_size=64, temperature=0.05):
        super().__init__()
        self.dim_mask = dim_mask
        self.mask_size = mask_size
        self.hidden_size = int(self.mask_size / 2)
        hidden_dim = int(1 * (self.mask_size / 2)**2)
